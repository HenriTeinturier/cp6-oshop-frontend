...
|-|-|-|-|
|id| INT | UNSIGNED, AUTO_INCREMENT, NOT NULL, PRIMARY KEY | Identifiant du produit |
|price| DECIMAL(10,2) | NOT NULL, DEFAULT 1 | Prix du produit |
|name| VARCHAR(64) | NOT NULL | Nom du produit|
|description| TEXT | NULL  | Description du produit|
|picture| VARCHAR(255) | NULL, DEFAULT 'images/image-par-defaut.png' | Image du produit|
|rate|BIT(1)|NOT NULL, DEFAULT 0| La note du produit de 0 à 5|
|status|BOOL| NOT NULL, DEFAULT 0 | Statut du produit (0 = désactivé, 1 = activé)|
