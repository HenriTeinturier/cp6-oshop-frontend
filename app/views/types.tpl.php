      ...
      <div class="hero-content pb-5 text-center">
        ...
        <div class="row">
          <div class="col-xl-8 offset-xl-2">
            <p class="lead text-muted">Pas de description dans la BDD.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            ...
            <h3 class="h6 text-uppercase mb-1"><a href="<?= $router->generate('page-product', ['id' => $productObjet->getId()])  ?>" class="text-dark"><?= $productObjet->getName() ?></a></h3><span class="text-muted"><?= $productObjet->getPrice() ?></span>
          </div>
        </div>        
        <?php endforeach ?>
        <!-- /product-->
